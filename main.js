var codigoUsado = document.getElementById('codificador');
codigoUsado.addEventListener('click', () => {
    if (codigoUsado.value == 'cesar') {
        opcoes1.style.display = 'flex';
        incremento.style.display = 'initial';
    } else if (codigoUsado.value == 'base') {
        opcoes2.style.display = 'flex';
    }
})

function codificarCesar() {
    var str = document.getElementById("meu-input").value
